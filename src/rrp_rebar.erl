...
%%
%% The result is as for {@link cfg_file_names/0}.
%%
...
%% exists.
%%
%% If one of the files returned by {@link cfg_file_names/0} exists, the first
%% such fully-qualified path is returned. If none of the files exists, the FQ
%% path of the first candidate name is returned.
%%
...
%%
%% The result is as for {@link config_format/0}.
%%
...
%%
%% The {@link in_checkouts/2} and {@link in_prj_or_checkouts/2} functions in
%% this module are valid predicate functions.
%%
